...
company_df = df[df['type'] == 'Company'].rename(columns={'id': 'company_id', 'LocationPlaceId': 'country_id'})
...
university_df = df[df['type'] == 'University'].rename(columns={'id': 'university_id', 'LocationPlaceId': 'city_id'})
